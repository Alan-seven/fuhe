 ...
 * @version 2020-03-17
 */
public class TSfmmWsaWtVO extends PageVO{
	...
	@ApiModelProperty(value = "生活用水")
	private Float lifw;			//生活用水
	@ApiModelProperty(value = "农业用水")
	private Float agrw;			//农业用水
	@ApiModelProperty(value = "工业用水")
	private Float indw;			//工业用水
	@ApiModelProperty(value = "林牧渔用水")
