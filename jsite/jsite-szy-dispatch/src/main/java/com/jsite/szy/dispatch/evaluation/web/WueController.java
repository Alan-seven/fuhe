 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/szy/evaluation/wue")
public class WueController extends BaseController {

    @Autowired
    private DdsWeWueService ddsWeWueService;
    ...
    public void getTemplate(HttpServletResponse response,
        ...
        XSSFWorkbook wb = ddsWeWueService.getTemplate(river);
        setFileDownloadHeader(response, "用水效率评价数据模板.xlsx");
    ...
    public void uploadData(HttpServletResponse response,
        ...
        writeString(response, ddsWeWueService.uploadData(file, river));
    }
