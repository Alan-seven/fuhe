 ...
 * @version 2020-03-24
 */
public class TSfrdWtrplanVerRsltVO extends PageVO{
	...
	@ApiModelProperty(value = "水田灌溉取用水量(万m3)")
	private Double awWw;		// 水田灌溉取用水量(万m3)
	@ApiModelProperty(value = "水浇地灌溉取用水量(万m3)")
	private Double adWw;		// 水浇地灌溉取用水量(万m3)
	@ApiModelProperty(value = "菜田灌溉取用水量(万m3)")
	private Double avWw;		// 菜田灌溉取用水量(万m3)
	@ApiModelProperty(value = "农田灌溉总取用地下水量(万m3)")
	private Double irrGwWw;		// 农田灌溉总取用地下水量(万m3)
	@ApiModelProperty(value = "林果灌溉取用水量(万m3)")
	private Double fiWw;		// 林果灌溉取用水量(万m3)
	@ApiModelProperty(value = "草场灌溉取用水量(万m3)")
	private Double aiWw;		// 草场灌溉取用水量(万m3)
	@ApiModelProperty(value = "鱼塘补水用水量(万m3)")
	private Double fishWu;		// 鱼塘补水用水量(万m3)
	@ApiModelProperty(value = "牲畜用水取用水量(万m3)")
	private Double rhWw;		// 牲畜用水取用水量(万m3)
	@ApiModelProperty(value = "林牧渔畜总取用地下水量(万m3)")
	private Double ffGwWw;		// 林牧渔畜总取用地下水量(万m3)
	@ApiModelProperty(value = "直流式火（核）电工业取用水量(万m3)")
	private Double ieWw;		// 直流式火（核）电工业取用水量(万m3)
	@ApiModelProperty(value = "循环式火（核）电工业取用水量(万m3)")
	private Double ixeWw;		// 循环式火（核）电工业取用水量(万m3)
	@ApiModelProperty(value = "国有及规模以上工业取用水量(万m3)")
	private Double ioWw;		// 国有及规模以上工业取用水量(万m3)
	@ApiModelProperty(value = "规模以下工业取用水量(万m3)")
	private Double icWw;		// 规模以下工业取用水量(万m3)
	@ApiModelProperty(value = "工业年取用地下水量(万m3)")
	private Double indGwWw;		// 工业年取用地下水量(万m3)
	@ApiModelProperty(value = "城镇建筑业取用水量(万m3)")
	private Double pbldWw;		// 城镇建筑业取用水量(万m3)
	@ApiModelProperty(value = "城镇服务业取用水量(万m3)")
	private Double psrvWw;		// 城镇服务业取用水量(万m3)
	@ApiModelProperty(value = "城镇公共年取用地下水量(万m3)")
	private Double pGwWw;		// 城镇公共年取用地下水量(万m3)
	@ApiModelProperty(value = "城镇居民生活取用水量(万m3)")
	private Double duWw;		// 城镇居民生活取用水量(万m3)
	@ApiModelProperty(value = "农村居民生活取用水量(万m3)")
	private Double drWw;		// 农村居民生活取用水量(万m3)
	@ApiModelProperty(value = "居民生活年总取用地下水量(万m3)")
	private Double dGwWw;		// 居民生活年总取用地下水量(万m3)
	@ApiModelProperty(value = "城镇环境水用水量(万m3)")
	private Double euWw;		// 城镇环境水用水量(万m3)
	@ApiModelProperty(value = "农村环境取用水量(万m3)")
	private Double erWw;		// 农村环境取用水量(万m3)
	@ApiModelProperty(value = "生态环境取用地下水量(万m3)")
	private Double eGwWw;		// 生态环境取用地下水量(万m3)
	@ApiModelProperty(value = "生活用水量(万m3)")
	private Double lifWw;		// 生活用水量(万m3)
	@ApiModelProperty(value = "农业用水量(万m3")
	private Double agrWw;		// 农业用水量(万m3)
	@ApiModelProperty(value = "工业用水量(万m3)")
	private Double indWw;		// 工业用水量(万m3)
	@ApiModelProperty(value = "生态用水量(万m3)")
	private Double ecoWw;		// 生态用水量(万m3)
	@ApiModelProperty(value = "总水量(万m3)")
