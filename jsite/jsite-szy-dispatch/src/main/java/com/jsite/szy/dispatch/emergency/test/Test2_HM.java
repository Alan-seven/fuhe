...
public class Test2_HM {
    ...
    public static void main(String[] args) {
        ...
        double LEN_UP=2; //起点距 = 距离上监测断面的距离+上断面的起点距   总长18.9m
        double DA=500;// 污染量 kg
