...
public class GetRoleInfoResponse  implements java.io.Serializable {
    private cn.com.dhcc.uums.service.uums.RoleInfo _return;

    public GetRoleInfoResponse() {
    }

    public GetRoleInfoResponse(
           cn.com.dhcc.uums.service.uums.RoleInfo _return) {
           this._return = _return;
    }


    /**
     * Gets the _return value for this GetRoleInfoResponse.
     * 
     * @return _return
     */
    public cn.com.dhcc.uums.service.uums.RoleInfo get_return() {
        return _return;
    }


    /**
     * Sets the _return value for this GetRoleInfoResponse.
     * 
     * @param _return
     */
    public void set_return(cn.com.dhcc.uums.service.uums.RoleInfo _return) {
        this._return = _return;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://uums.service.uums.dhcc.com.cn/", "getRoleInfoResponse"));
