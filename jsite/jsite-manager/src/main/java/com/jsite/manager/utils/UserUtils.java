/**
 */
package com.jsite.manager.utils;
...
public class UserUtils {
	...
	/*public static User get(String id){
		...
		if (user ==  null){
			...
			user.setRoleDOList(roleDao.list(new Role(user)));
	...
	public static List<Role> getRoleList(){
		...
		if (roleList == null){
			...
			if (user.isAdmin()){
				...
				role.getSqlMap().put("dsf", AbstractBaseService.dataScopeFilter(getUser(), "o", "u"));
	...
	*//**
	...
	public static List<Menu> getMenuList(){
		...
		if (menuList == null){
			User user = getUser();
			if (user.isAdmin()){
				menuList = menuDao.listAll(new Menu());
			}else{
				Menu m = new Menu();
