 ...
 * @version 2020-03-17
 */
public class TSfrdWtrplanInitcond extends AbstractData<TSfrdWtrplanInitcond> {
	...
	private Float ww;		//需水量
	private Date ts;		// 时间戳
	private String nt;		// 备注
	
	public TSfrdWtrplanInitcond() {
		super();
	}

	public TSfrdWtrplanInitcond(String id){
		super(id);
	}
