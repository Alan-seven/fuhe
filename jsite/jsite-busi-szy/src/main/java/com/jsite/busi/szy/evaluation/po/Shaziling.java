 ...
 */
public  class Shaziling {
//    沙子岭
    public   double p=3;
    public   double pa=-0.14138;
    public   double pb0=0.02084;
    public   double pb1=-0.00323;

    private static List<Double> A = new ArrayList<Double>();
    private static List<Double> B = new ArrayList<Double>();

    public   double A1=	-1.29801;
    public   double A2=	1.37447;
    public   double A3=	-1.09006;
    public   double A4=	2.01829;
    public   double B1=	0.78864;
    public   double B2=	-0.64951;
    public   double B3=	-0.81548;
    public   double B4=	0.46752;
