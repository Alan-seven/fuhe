 ...
 * @version 2017-06-07
 */
public class DdsEdEvent extends AbstractData<DdsEdEvent> {
	...
	private String fkevenCd; //溯源表事件外键
	//追踪溯源时间
	...
	public String getFkevenCd() {
		return fkevenCd;
	}

	public void setFkevenCd(String fkevenCd) {
		this.fkevenCd = fkevenCd;
	}
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getTm() {
		return tm;
